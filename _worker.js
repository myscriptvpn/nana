...
// Constant
const GH_URL = "https://raw.githubusercontent.com/myscriptvpn/nana/refs/heads/main";
const APP_DOMAIN = `${serviceName}.${rootDomain}`;
const PORTS = [443, 80];
const PROTOCOLS = ["trojan", "vless", "ss"];
const KV_PROXY_URL = `${GH_URL}/kvProxyList.json`;
const PROXY_BANK_URL = `${GH_URL}/proxyList.txt`;
